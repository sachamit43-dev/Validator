...
class ProjectGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Project entity")
        ...
        .repeat(2) {
            ...
            .get("/services/validator/api/projects")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new project")
            .post("/services/validator/api/projects")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
            ...
            .repeat(5) {
                ...
                .get("/services/validator${new_project_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created project")
            .delete("/services/validator${new_project_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
