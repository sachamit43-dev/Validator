...
class OrganizationGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Organization entity")
        ...
        .repeat(2) {
            ...
            .get("/services/validator/api/organizations")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new organization")
            .post("/services/validator/api/organizations")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "orgName":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/services/validator${new_organization_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created organization")
            .delete("/services/validator${new_organization_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
